...
public class ConVic : MonoBehaviour
{
    ...
    [SerializeField] private int puntuacionPlayer = 0;//Puntuaci�n del jugador.
    [SerializeField] private int puntuacionParaDerrota = 0;//Indica la puntuaci�n para perder.
    ...
    private bool _freezeEnemys = false;
    ...
    {
        //////////////////////////////////////////////////////////////////////////////////////////
        ///Si el jugador tiene 8 estrellas, se activa la animaci�n de abrir la puerta.
        if (puntuacionPlayer == 8) anim.SetBool("Abrir Puerta", true);
        //////////////////////////////////////////////////////////////////////////////////////////

        //////////////////////////////////////////////////////////////////////////////////////////
        ///Si la puntuaci�n del jugador es mayor o igual a 8, tiene contacto con la puerta y presiona
        ///la tecla Enter o el bot�n de la pantalla t�ctil, se activa la victoria.
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        ...
        if (collision.tag == "Puerta")
        {
            ...
            //////////////////////////////////////////////////////////////////////////////////////////
            ///Si la puntuaci�n del jugador es mayor o igual a 8, se activa el boton tactil Enter o
            ...
            //////////////////////////////////////////////////////////////////////////////////////////
            //Si el jugador esta cargando una estrella, se suma un punto a la puntuaci�n del jugador,
    ...
    private void PerderEstrella()
    {
        ...
        anim.Play("Damage");//Animaci�n de perder una estrella.
        invulnerabilityTime = true;//Se activa una invulnerabilidad para el jugador por 1 segundos.
        StartCoroutine(PerderEstrella(2f));//Corrutina que desactiva la invulnerabilidad del jugador y la animaci�n de perder la estrella.
        cargandoEstrella = false;//Se desactiva la variable que indica que el jugador esta cargando una estrella.
        puntuacionParaDerrota++;//Se suma un punto a la variable que indica la puntuaci�n para perder.

        //////////////////////////////////////////////////////////////////////////////////////////
        ///Si la puntuaci�n para perder es igual a 3 se desactivan los botones de la pantalla
        ///t�ctil, se reproduce el sonido de derrota y se activa el menu de GameOver.
    ...
    {
        ///Devuelve la puntuaci�n del jugador a la clase Anim De La Puerta
    ...
    IEnumerator deadScreen(float Tiempo)
    {
        ...
        sfx.PlayDaño();//Sonido de da�o.
        sfx.PlayGG();//Sonido de derrota.
        anim.Play("Dead");//Animaci�n de muerte.
        alreadyDead = true;//Indica que el jugador ya murio.
        btn_izq.enabled = btn_der.enabled = btn_salto.enabled = btnPause.enabled = false;//Desactiva los botones de la pantalla t�ctil.
        yield return new WaitForSeconds(Tiempo);
        menuGameOver.SetActive(true);//Activa el menu de GameOver.
    }
    public float FreezeEnemys()
    {
        if(_freezeEnemys)
        {
            return 0;
    ...
    public void GodMode()
    {
        if(!estrella.enabled) estrella.enabled = true;
        else estrella.enabled = false;
